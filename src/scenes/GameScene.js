...
class GameScene extends Phaser.Scene {
    ...
    create() {
        console.log('premier test', this.currentCustomer)
        ...
        console.log('deuxième test', this.rolePlayer, this.partie, this.emotions, this.cocktails)
        ...
        if (!this.isSolo) {
            ...
            this.showFinalDialogue().then(() => {
                if (this.game.registry.get('nbrCustomers') > 0 && this.ajoutClient == true) {
                    ...
                    this.currentCustomer = new Customer(this, 300, 300, this.findObjectById(this.emotions, this.dataCustomer[0]), this.findObjectById(this.cocktails, this.dataCustomer[1]), this.dataCustomer[2]);
                    this.canva.customer = this.currentCustomer;
